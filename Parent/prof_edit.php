                                ...
                                <form action="code.php" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="disc" value="<?= $row['disc']; ?>" class="form-control">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label>Overall Performance Marks</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" name="cert" value="<?= $row['cert']; ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
