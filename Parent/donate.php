...
<body>
  ...
  <div class="form-container" style="margin-left: 100px;">
    ...
    <!-- <div class="btnAdd">
      <a href="#!" data-id="" data-bs-toggle="modal" type="hidden" data-bs-target="#addDonateModal"
        class="btn btn-success btn-sm">Pay</a>
    </div> -->
    <!-- <div>
    <a href="pay.php" class="btn btn-primary float-end">Pay</a>
    </div> -->
    <!-- <div class="row"> -->
      ...
      <div class="col-md-10">
        ...
        <center>
          <div class="form-box" style="margin-top: 70px;">
            ...
            <br>
            <div class="inputBox">
              <span><b>Bank Account Information</b></span>
              <span><br><b>CIMB
                  <br>
                  Ali Bin Ahmad (Assistant School Finance)
                  <br>
                  7634454637</b></span>
            </div>
          </div>
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            if (status == 'true') {
              ...
              var button = '<td style="visibility:collapse"><a href="javascript:void();" data-id="' + id + '" class="btn btn-info btn-sm editbtn" style="display: none;">Edit</a>  <a href="#!"  data-id="' + id + '"  class="btn btn-danger btn-sm deleteBtn" style="display: none;">Delete</a></td>';
