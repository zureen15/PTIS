                ...
                <div class="card" style="margin-top: 120px; margin-left: 130px;"><?php include ('message.php'); ?>
                    <div class="card-header">
                        <h4 class="text-center">Student Profile Details
                            <a href="prof_create.php" class="btn btn-primary float-end" style="display: none;">Add
                                Students</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped" class="center">
                            ...
                            <tbody>
                                <?php
                                $i = 1;
                                $query = "SELECT * FROM stud_profile WHERE id = 15";
                                    ...
                                    foreach ($query_run as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="prof_edit.php?id=<?= $row['id']; ?>" class="btn btn-success btn-sm"
                                                    style="display: none;">Edit</a>
                                                <form action="code.php" method="POST" class="d-inline">
                                                    <button type="submit" name="delete_prof" value="<?= $row['id']; ?>"
                                                        class="btn btn-danger btn-sm" style="display: none;">Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                        <?php
