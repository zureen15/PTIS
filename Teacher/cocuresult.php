		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT b.*,concat(s.firstname,' ',s.lastname) as name,s.student_code,concat(c.level,'-',c.section) as class FROM cocu_results b inner join class c on c.id = b.class_id inner join students s on s.id = b.student_id inner join user_form us on b.class_id = us.class_id $where order by unix_timestamp(b.date_created) desc ");
