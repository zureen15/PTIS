...
if(isset($_POST['update_prof']))
{
    ...
    $query = "UPDATE stud_profile SET `stud_name`='$stud_name',`disc`='$disc',`dob`='$dob',`allergy`='$allergy',`perf`='$perf',`cert`='$cert' WHERE id = $id";
    $query_run = mysqli_query($con, $query);
...
if(isset($_POST['save_prof']))
{
    ...
    $query = "INSERT INTO stud_profile (stud_name,disc,dob,allergy,perf,cert) VALUES ('$stud_name','$disc','$dob','$allergy','$perf','$cert')";
