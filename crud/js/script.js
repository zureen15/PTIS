...
function getplayerrow(player) {
  ...
  if (player) {
    ...
    playerRow = `<tr>
          ...
          <td class="align-middle" style="padding-left: 150px;">
  ...
  $(document).on("submit", "#addform", function (event) {
    ...
    var alertmsg =
      $("#userid").val().length > 0
        ...
        : "New Announcement has been added Successfully!";
    $.ajax({
      url: "../crud/ajax.php",
      type: "POST",
      dataType: "json",
    ...
    if (confirm("Are you sure want to delete this?")) {
      $.ajax({
        ...
        success: function (res) {
          if (res.deleted == 1) {
            $(".message")
              .html("Announcement has been deleted successfully!")
              .fadeIn()
              .delay(3000)
              .fadeOut();
            getplayers();
            ...
            `<div class="row">
              ...
              <div class="row">
                <div class="col-sm-6 col-md-12" style="text-align: center;">
                  <h4 class="text-primary" style="text-align: center;">${player.pname}</h4>
                  <p class="text-secondary">
                    <i class="fa fa-check-square" aria-hidden="true"></i> ${player.email}
                    <br />
