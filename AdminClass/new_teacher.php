          ...
          <div class="col-md-6">
            ...
            <div class="form-group text-dark">
              <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm" name="teacher_code" value="<?php echo isset($teacher_code) ? $teacher_code : '' ?>" required>
              </div>
            </div>
            <div class="form-group text-dark">
              <div class="form-group">
            ...
            <div class="form-group text-dark">
              <div class="form-group">
                ...
                <select name="class_id" id="" class="form-control select2 select2-sm" required>
                  <option></option> 
                  <?php 
                        $class = $conn->query("SELECT * FROM class order by level asc,section asc ");
...
<script>
	$('#manage-teacher').submit(function(e){
		...
		$.ajax({
          ...
          $('#msg').html('<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Teacher Code already exist.</div>')
          end_load()
        }
			}
		})
