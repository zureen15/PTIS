...
if (isset($_POST['update_profile'])) {
   ...
   mysqli_query($conn, "UPDATE `user_form` SET name = '$update_name', email = '$update_email' WHERE id = '$admin_id'") or die('query failed');
   ...
   if (!empty($update_image)) {
      if ($update_image_size > 2000000) {
         ...
         $image_update_query = mysqli_query($conn, "UPDATE `user_form` SET image = '$update_image' WHERE id = '$admin_id'") or die('query failed');
...
<body>
   ...
   <?php
   include "../sidemenu/sidebaradmin.php";
   ?>
